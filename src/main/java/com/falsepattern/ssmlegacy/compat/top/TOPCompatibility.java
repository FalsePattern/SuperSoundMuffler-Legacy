package com.falsepattern.ssmlegacy.compat.top;
...
public class TOPCompatibility {
    ...
    public static void register() {
        if (registered)
            return;
        registered = true;
        FMLInterModComms.sendFunctionMessage("theoneprobe", "getTheOneProbe", "com.falsepattern.ssmlegacy.compat.top.TOPCompatibility$GetTheOneProbe");
    }
